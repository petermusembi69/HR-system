    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center">
                <hr>
                <div><p class="text-monospace">Search for individual employees </p></div>
                <hr/>
            </div>
        </div>
    </div>
  <div class="container-fluid">
        ...
        <div class="col-md-4"></div>
            <div class="col-md-4 text-center">
              <form method="POST" class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" id="searchemp_hr" placeholder="email@gmail.com">
                <button class="btn btn-outline-success my-2 my-sm-0" id="searchemp_btn">Search</button>
              </form>
            </div>
        <div class="col-md-4"></div>
        </div>
    ...
    <div class="container-fluid">
		     <div class="row">
				 ...
				 <div class="col-md-10" id="get_emp"></div>
				 <!--student results -->
				 <div class="col-md-1"></div>
			 </div>
       </div>
